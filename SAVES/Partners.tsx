...
import { MapPin, Mail, Phone, Globe, User, Share2 } from "lucide-react";
...
// Ferrari events ¿?
  ...
  const filtrati = categoria === "Tutto"
    ? partners
    : partners.filter((p) => p.categoria === categoria);

  return (
    <section className="bg-white pt-48">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-burdeaux mb-2">
          I Nostri Partners
        </h2>
        <p className="mb-8">
          Scopri i professionisti con cui collaboriamo per rendere ogni evento unico.
        </p>
        ...
        <div className="flex justify-center items-center">
          <div className="flex flex-1 gap-x-1 mx-[70%]">
            <button
              onClick={() => setOpen(true)}
              className="inline-block bg-amarilloPastel text-burdeaux text-xl font-semibold px-4 py-2 my-16 rounded-sm
